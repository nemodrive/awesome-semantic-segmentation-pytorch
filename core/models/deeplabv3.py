...
__all__ = ['DeepLabV3', 'get_deeplabv3', 'get_deeplabv3_resnet50_voc', 'get_deeplabv3_resnet101_voc',
           ...
           'get_deeplabv3_resnet152_ade', 'get_deeplabv3_resnet50_upb']
...
def get_deeplabv3(dataset='pascal_voc', backbone='resnet50', pretrained=False, root='~/.torch/models',
    ...
    if pretrained:
        ...
        model.load_state_dict(torch.load(get_model_file('deeplabv3_%s_%s_best_model' % (backbone, acronyms[dataset]), root=root),
                              map_location=device))
    return model
